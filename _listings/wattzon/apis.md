...
created: "2018-08-23"
modified: "2018-08-23"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/energy/master/_listings/wattzon/apis.md
specificationVersion: "0.14"
apis:
- name: WattzOn
  x-api-slug: wattzon
  description: 'WattzOn liberates data with two flagship products: MR BILL is a machine
    learning system that extracts data from structured documents such as invoices,
    utility bills, and healthcare records. LINK is the industry-leading vertical API
    for utility data, co...'
  image: http://kinlane-productions.s3.amazonaws.com/screen-capture-api/277-wattzon.jpg
  humanURL: http://www.wattzon.com/
  baseURL: https:///
  tags: Energy
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/energy/master/_listings/wattzon/openapi.md
x-common:
- type: x-blog
